    ...
    try {
        ...
        for (const link of eventLinks) {
            ...
            try {
                ...
                try {
                    subtitle = (_a = yield page.$eval(".field--name-field-subtitle", (el) => { var _a; return ((_a = el.textContent) === null || _a === void 0 ? void 0 : _a.trim()) || ""; })) !== null && _a !== void 0 ? _a : "";
                }
                catch (e) {
                    console.error("Missing subtitle for", link);
                }
                const dateElement = yield page.$(".field--name-field-event-date time");
